...
CATEGORY_MAP = {
    ...
    "Какао-бобы (USD)": "Стимулирующие культуры",
    "Табак": "Стимулирующие культуры",
    "Табак (USD)": "Стимулирующие культуры",
    ...
    # Дополнительные товары (USD)
    "Кокосовое масло (USD)": "Масла и шроты",
    "Пальмовое масло (USD)": "Масла и шроты",
...
BEST_PREDICTORS_FOR_INDEX = {
    ...
    "Инфляция, г/г": ['USDRUB'],
    "Какао-бобы (USD)": ['USDRUB'],
    "Табак (USD)": ['USDRUB'],
    "Кокосовое масло (USD)": ['USDRUB'],
    "Пальмовое масло (USD)": ['USDRUB'],
    "USDRUB": ['USDRUB']
